...
func main() {
	...
	liveVADSilenceDuration := flag.Duration("live-vad-silence-duration", envDuration("AGENT_API_LIVE_VAD_SILENCE_DURATION", 350*time.Millisecond), "Gemini Live VAD silence duration before confirming speech end")
