...
func main() {
	...
	liveVADPrefixPadding := flag.Duration("live-vad-prefix-padding", envDuration("AGENT_API_LIVE_VAD_PREFIX_PADDING", 40*time.Millisecond), "Gemini Live VAD detected speech duration before confirming speech start")
	liveVADSilenceDuration := flag.Duration("live-vad-silence-duration", envDuration("AGENT_API_LIVE_VAD_SILENCE_DURATION", 180*time.Millisecond), "Gemini Live VAD silence duration before confirming speech end")
