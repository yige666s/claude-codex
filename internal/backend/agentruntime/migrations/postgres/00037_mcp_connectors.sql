...
CREATE INDEX IF NOT EXISTS idx_agent_connector_tokens_provider_updated
...
CREATE INDEX IF NOT EXISTS idx_agent_mcp_servers_user_updated
  ON agent_mcp_servers (user_id, workspace_id, updated_at DESC);

CREATE TABLE IF NOT EXISTS agent_mcp_tool_policies (
...
CREATE INDEX IF NOT EXISTS idx_agent_mcp_tool_policies_server_tool
