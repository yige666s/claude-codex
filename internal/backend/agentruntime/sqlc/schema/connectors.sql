...
CREATE INDEX idx_agent_connector_connections_user_updated
  ON agent_connector_connections (user_id, workspace_id, updated_at DESC);

CREATE TABLE agent_connector_oauth_states (
...
CREATE INDEX idx_agent_connector_oauth_states_user_provider
