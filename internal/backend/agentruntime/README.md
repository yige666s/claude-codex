...
- `AGENT_API_LIVE_VAD_START_SENSITIVITY=START_SENSITIVITY_LOW`
- `AGENT_API_LIVE_VAD_END_SENSITIVITY=END_SENSITIVITY_LOW`
- `AGENT_API_LIVE_VAD_PREFIX_PADDING=450ms`
- `AGENT_API_LIVE_VAD_SILENCE_DURATION=900ms`
