...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar ref={ref} orientation={orientation} className={cn("ui-scrollbar", orientation === "horizontal" && "ui-scrollbar-horizontal", className)} {...props}>
